...
function solve() {
    ...
    function createPreview(firstName, lastName, dateIn, dateOut, peopleCount){
        ...
        const editButn = e("button", "Edit");
        editButn.className = "edit-btn";
        editButn.addEventListener("click", () => onEditClick(firstName, lastName, dateIn, dateOut, peopleCount));
        const continueBtn = e("button", "Continue");
        continueBtn.className = "continue-btn";
        continueBtn.addEventListener("click", onContinueClisk.bind(null, firstName, lastName, dateIn, dateOut, peopleCount));

        element.appendChild(editButn);
    ...
    function onContinueClisk(firstName, lastName, dateIn, dateOut, peopleCount){
    ...
    function createConfirmation(firstName, lastName, dateIn, dateOut, peopleCount){
        ...
        const confirmButn = e("button", "Confirm");
        confirmButn.className = "confirm-btn";
        confirmButn.addEventListener("click", onFinishClisk.bind(null, true));
        
        const cancelBtn = e("button", "Cancel");
        cancelBtn.className = "cancel-btn";
        cancelBtn.addEventListener("click", onFinishClisk(null, false));

        element.appendChild(confirmButn);
        element.appendChild(cancelBtn);

        return element;
    }

    function onFinishClisk(confirmed){
